...
dclose = DCLOSE(arch="yolox", model=model, img_size=(640, 640), n_samples=1000)
...
for img_path in tqdm(img_paths):
    try:
        ...
        np.save(f"xai_methods/output/{name_img}.npy", rs)
        ...
        with torch.no_grad():
            ...
            if box is None:
                continue
            saliency_map = np.load(f"xai_methods/output/{name_img}.npy")
